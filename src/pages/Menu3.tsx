      ...
      <div className={styles.thanhTriParent}>
        ...
        <div className={styles.thanhMunuWrapper}>
          <div className={styles.thanhMunu}>
            <div className={styles.div7}>Десерты</div>
        ...
        <div className={styles.frameParent}>
          ...
          <div className={styles.div18}>Перчать на кухнии</div>
          <div className={styles.div19}>Комментария</div>
        </div>
