...
import styles from "./Menu6.module.css";

const Menu6: FunctionComponent = () => {
    ...
    <div className={styles.menu7}>
      <div className={styles.thanhTriParent}>
        ...
        <div className={styles.frameParent}>
          ...
          />
          <div className={styles.div26}>Фо-бо</div>
          <div className={styles.div27}>Суп фо га</div>
          <div className={styles.div28}>Ком бо лук лак</div>
